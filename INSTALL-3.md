...
```bash
wget https://github.com/mxssl/tg-captcha-bot/releases/download/v1.1.0/tg-captcha-bot_1.1.0_linux_amd64.tar.gz

tar xvzf tg-captcha-bot_1.1.0_linux_amd64.tar.gz
